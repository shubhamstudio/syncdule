    ...
    return (
        <>
            <div className="flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                <PageHeader eyebrow="Content system" title="Ideas" description="Capture sparks, shape campaigns, and move each idea toward publishing." actions={<>
                ...
                <div className="min-h-0 min-w-0 flex-1">
                    <div className="kanban--board relative flex h-full min-w-0 max-w-full overflow-x-auto overflow-y-hidden px-4 py-5 md:px-6">
                        {isPending ? (
                            <div className="flex h-full min-w-max gap-4 pr-4">
                                {[1, 2, 3, 4].map((i) => (
                                    <div key={i} className="shrink-0 w-[280px] flex flex-col h-full min-h-0 
                rounded-lg border border-white/10 bg-white/[0.025] p-3">
                            ...
                            <EmptyState
                                title="Your idea board is ready"
                                description="Create your first idea group in the workspace configuration, then capture hooks, prompts, and campaign concepts here."
                            />
                        ) : (
                                            ...
                                            >
                                                <div className="flex items-center justify-between px-3 pt-3 pb-2">
                                                    <div className="flex items-center gap-2">
                                                        <h3 className="font-mono text-[11px] font-semibold uppercase tracking-[0.13em] text-foreground">
                                                            {column.title}
                                                        </h3>
                                        ...
                                        <Draggable
                                            ...
                                            {(provided, snapshot) => (
                                                <Card
                                                    ...
                                                    className={cn(
                                                        "group cursor-pointer! rounded-md! border-white/10 bg-[#111114] shadow-none active:cursor-grabbing transform transition-all hover:border-primary/45 hover:bg-white/[0.035]",
                                                        snapshot.isDragging &&
                                                        "scale-95 rotate-1 border-primary/60 shadow-lg shadow-black/30",
                                                    )}
