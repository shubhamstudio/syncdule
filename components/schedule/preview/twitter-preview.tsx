...
import { APP_NAME, DEFAULT_SOCIAL_HANDLE } from "@/constants/app"
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5">
              <span className="text-sm font-bold">{handle || APP_NAME}</span>
              <span className="text-xs text-muted-foreground">@{handle || DEFAULT_SOCIAL_HANDLE}</span>
            </div>
